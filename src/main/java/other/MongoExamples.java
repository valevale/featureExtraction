...
public class MongoExamples {
    public static void main( String[] args ){
    	...
    	morphia.mapPackage("featureExtractor");
        ...
        System.out.println("numero di impiegati:" + employees.size());
        
        List<Employee> underpaid = datastore.createQuery(Employee.class)
                .filter("salary <=", 30000).asList();
        
        System.out.println("numero di impiegati sottopagati:" + underpaid.size());
